...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/accounts.AccountRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.AccountDataResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.AccountsDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.AccountUpdateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/google/login": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "Set true untuk sesi lebih lama",
                        "name": "remember",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.UserDataResponse"
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.CategoriesDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.CategoryDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/groups.GroupRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.GroupDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.GroupsDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/invitations": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Data undangan",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/invitations.InvitationRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.InvitationDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/invitations/accept": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Data penerimaan undangan",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ProfileDataResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/transactions": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Group ID (isi saat scope=group)",
                        "name": "group_id",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "personal atau group",
                        "name": "scope",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "file",
                        "description": "Lampiran transaksi (boleh multiple)",
                        "name": "attachments",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handler.TransactionDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.TransactionResponseBody"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.UsersDataResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "groups.GroupResponse": {
            ...
            "properties": {
                ...
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/groupmembers.GroupMemberResponse"
                    }
                },
                "name": {
                    "type": "string"
        ...
        "handler.CategoriesDataResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "handler.InvitationDataResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/invitations.Invitation"
                }
            }
        },
        ...
        "handler.ProfileDataResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/userprofile.UserProfileResponse"
                }
            }
        },
        "handler.TransactionDataResponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handler.TransactionResponseBody": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/transactions.TransactionResponse"
        ...
        "transactionlines.TransactionLineResponse": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "string"
        ...
        "transactions.TransactionResponse": {
            ...
            "properties": {
                "attachments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/attachments.AttachmentResponse"
                    }
                },
                "category": {
                    "$ref": "#/definitions/categories.CategoryMini"
                },
                "category_id": {
                    "type": "string"
                },
                ...
                "transaction_lines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/transactionlines.TransactionLineResponse"
                    }
                },
                "type": {
                    "type": "string"
        ...
        "transactions.Transactions": {
            ...
            "properties": {
                "attachments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/attachments.Attachment"
                    }
                },
                "category": {
                ...
                "transaction_lines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/transactionlines.TransactionLine"
                    }
                },
                "type": {
                    "type": "string"
